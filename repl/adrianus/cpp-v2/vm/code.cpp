...
Code::Code() {
    ...
    definitionsMap.insert(std::make_pair(OP_GET_THIS, new Definition("OpGetThis", 0, new int)));
    definitionsMap.insert(std::make_pair(OP_GET_SUPER_METHOD, new Definition("OpGetSuperMethod", 0, new int)));
