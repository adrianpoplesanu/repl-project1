...
Code::Code() {
    ...
    definitionsMap.insert(std::make_pair(OP_ADD, new Definition("OpAdd", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_SUB, new Definition("OpSub", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_MULTIPLY, new Definition("OpMultiply", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_DIVIDE, new Definition("OpDivide", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_MOD, new Definition("OpMod", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_POP, new Definition("OpPop", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_TRUE, new Definition("OpTrue", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_FALSE, new Definition("OpFalse", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_EQUAL, new Definition("OpEqual", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_NOTEQUAL, new Definition("OpNotEqual", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_GREATERTHAN, new Definition("OpGreaterThan", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_GREATERTHAN_EQUAL, new Definition("OpGreaterThanEqual", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_AND, new Definition("OpAnd", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_OR, new Definition("OpOr", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_MINUS, new Definition("OpMinus", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_BANG, new Definition("OpBang", 0, nullptr)));
    ...
    definitionsMap.insert(std::make_pair(OP_NULL, new Definition("OpNull", 0, nullptr)));
    ...
    definitionsMap.insert(std::make_pair(OP_INDEX, new Definition("OpIndex", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_SET_INDEX, new Definition("OpSetIndex", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_POSTFIX_INDEX, new Definition("OpPostfixIndex", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_SLICE, new Definition("OpSlice", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_PATCH_INDEX, new Definition("OpPatchIndex", 0, nullptr)));
    ...
    definitionsMap.insert(std::make_pair(OP_RETURN_VALUE, new Definition("OpReturnValue", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_RETURN, new Definition("OpReturn", 0, nullptr)));
    ...
    definitionsMap.insert(std::make_pair(OP_CURRENT_CLOSURE, new Definition("OpCurrentClosure", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_CLASS, new Definition("OpClass", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_SET_METHOD, new Definition("OpSetMethod", 0, nullptr)));
    definitionsMap.insert(std::make_pair(OP_GET_PROPERTY, new Definition("OpGetProperty", 0, nullptr))); // TODO: this should have operands
    definitionsMap.insert(std::make_pair(OP_SET_PROPERTY, new Definition("OpSetProperty", 0, nullptr))); // TODO: this should have operands
    definitionsMap.insert(std::make_pair(OP_GET_METHOD, new Definition("OpGetMethod", 0, nullptr)));
